...
1. Logika przepływu "zatwierdzeń": Funkcja, w której użytkownik musi zatwierdzić zadanie wykonane przez asystenta,
...
1. Zarządzanie zagnieżdżonymi danymi: Reprezentacja hierarchii zadań w bazie danych i API może być skomplikowana,
