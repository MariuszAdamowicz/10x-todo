-- migration: 20251130204500_get_tasks_with_counts.sql
-- description: creates an rpc function to fetch tasks along with their sub-task counts.
--
-- this function is a more efficient way to get tasks and their associated
-- sub-task counts (active, completed, canceled) in a single database query,
-- avoiding the n+1 problem on the client side.
