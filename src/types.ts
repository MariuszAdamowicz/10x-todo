 ...
 * and Command Models used in API requests and responses.
 *
 * These types are derived from the database entity types generated by Supabase to ensure
 * consistency and type safety between the database and the API layer.
 */
...
/**
 * Command model for reordering tasks.
 * Contains the parent of the tasks and an ordered list of their IDs.
 * Used in: `POST /tasks/reorder`
 */
export type TaskReorderCommand = {
